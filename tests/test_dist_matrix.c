...
char* test_count_lines() {
    int count;
    count = CountDataSize("Data/fake.tsp");
...
char* test_real_data() { 
    int count;
    count = CountDataSize("Data/ca4663.tsp");
...
char* test_italian_cities() {
    int count;
    count = CountDataSize("Data/it16862.tsp");
...
char* test_dist_loading() {
    ...
    int count;
    const char* filename = "Data/fake.tsp";
...
char* test_canada_cities() {
    ScratchArena arena = createArena(ARENA_SIZE);
    int count;
    const char* filename = "Data/ca4663.tsp";
    count = CountDataSize(filename);
