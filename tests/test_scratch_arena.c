...
char *test_alloc_normal() {
    ...
    void* ptr = arenaScratchAlloc(&arena, 64, ALIGN_8);
...
char *test_alloc_overflow() {
    ...
    void* ptr = arenaScratchAlloc(&arena, 32, ALIGN_16);
...
char* test_alloc_zero_size() {
    ...
    void* ptr = arenaScratchAlloc(&arena, 0, ALIGN_1);
...
char *test_alloc_exact_boundary() {
    ...
    void* ptr = arenaScratchAlloc(&arena, 32, ALIGN_8);
...
char *test_push_pop() {
    ...
    void* ptr = arenaScratchAlloc(&arena, 256, ALIGN_16);
...
char *test_hundred_bytes_align() {
    ...
    void* ptr = arenaScratchAlloc(&arena, 100, ALIGN_4);
...
char *test_zero_with_high_alignment() {
    ...
    mu_assert(arena.base != NULL, "Expect arena allocation.\n");
    arenaScratchPush(&arena);
    void* ptr = arenaScratchAlloc(&arena, 0, ALIGN_64);
...
char *test_overflow_huge_allocation() {
    ...
    mu_assert(arena.base != NULL, "Expect arena allocation.\n");
    arenaScratchPush(&arena);
    void* ptr = arenaScratchAlloc(&arena, SIZE_MAX, ALIGN_1);
...
char *test_odd_alignment() {
    ...
    mu_assert(arena.base != NULL, "Expect arena allocation.\n");
    arenaScratchPush(&arena);
    void* ptr = arenaScratchAlloc(&arena, 64, 3);
...
char *test_one_align() {
    ...
    mu_assert(arena.base != NULL, "Expect arena allocation.\n");
    arenaScratchPush(&arena);
    void* ptr = arenaScratchAlloc(&arena, 32, ALIGN_1);
    mu_assert(arena.offset == 32, "Expect no padding\n");
    void* ptr2 = arenaScratchAlloc(&arena, 32, ALIGN_1);
    mu_assert(arena.offset == 64, "Expect no padding\n");
    void* ptr3 = arenaScratchAlloc(&arena, 32, ALIGN_1);
...
char *test_alignment_is_aligned() {
    ...
    mu_assert(arena.base != NULL, "Expect arena allocation.\n"); 
    arenaScratchPush(&arena);
    void* ptr = arenaScratchAlloc(&arena, 20, ALIGN_8);
    void* ptr2 = arenaScratchAlloc(&arena, 8, ALIGN_8);
    void* ptr3 = arenaScratchAlloc(&arena, 5, ALIGN_8);
    ...
    void* ptr4 = arenaScratchAlloc(&arena, 1, ALIGN_2);
    void* ptr5 = arenaScratchAlloc(&arena, 1, ALIGN_2);
    void* ptr6 = arenaScratchAlloc(&arena, 1, ALIGN_2);
    ...
    void* ptr7 = arenaScratchAlloc(&arena, 3, ALIGN_4);
    void* ptr8 = arenaScratchAlloc(&arena, 31, ALIGN_4);
    void* ptr9 = arenaScratchAlloc(&arena, 16, ALIGN_4);
